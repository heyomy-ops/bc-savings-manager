      ...
      <div className="w-full">
        ...
        <div className="flex flex-col gap-4 md:gap-0 md:divide-y md:divide-neutral-100 dark:md:divide-neutral-800/50 text-sm">
          {members.map((member) => {
            ...
            return (
              <div key={member.id} className="bg-white dark:bg-transparent border md:border-0 border-neutral-200 dark:border-neutral-800 rounded-xl md:rounded-none overflow-hidden shadow-sm md:shadow-none hover:bg-neutral-50/50 dark:hover:bg-neutral-800/20 transition-colors">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pl-3 border-l-2 border-indigo-400 dark:border-indigo-600">
                      ...
                      <div className="flex flex-col md:flex-row md:items-center gap-3">
                        ...
                        {!isEmiFormOpen ? (
                          ...
                          <form onSubmit={(e) => handleRepayPrincipal(e, member)} className="flex items-center gap-2 w-full md:w-auto">
